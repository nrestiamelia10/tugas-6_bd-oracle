          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM PEMBELIAN_10019 WHERE ID_PEMBELIAN = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_update_pembelian.php" method="post">
			 <div class="form-row">
				
				
				  <input type="hidden" class="form-control" name="id_pembelian" value="<?= $d['ID_PEMBELIAN'] ?>" >
				
				<div class="form-group col-md-6">
				  <label for="">JUMLAH_BELI</label>
				  <input type="text" class="form-control" name="jumlah_beli" value="<?= $d['JUMLAH_BELI'] ?>">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
