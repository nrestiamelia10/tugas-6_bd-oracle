          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM JENIS_BARANG_0019 WHERE ID_JENIS_BARANG = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_update_jenis_barang.php" method="post">
			 <div class="form-row">
				
				
				  <input type="hidden" class="form-control" name="id_jenis_barang" value="<?= $d['ID_JENIS_BARANG'] ?>" >
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="jenis_barang" value="<?= $d['JENIS_BARANG'] ?>">
				</div>				
			  </div>																											
